    ...
    def validate_sp_reply(
        ...
        *,
        ...
        Args:
            ...
            allow_clinical: SP 病例诊疗场景下是否放行检查结果/治疗话术。
                开启后，SP 可以如实汇报医生已开立的化验/影像结果、并配合讨论治疗方案；
                但隐藏疾病泄露与系统提示词泄露仍会被拦截。
        ...
        safety = safety_policy.check_output(
            reply, hidden_disease=hidden_disease, allow_clinical=allow_clinical
        )
        ...
        #    SP 病例诊疗场景（allow_clinical）下，SP 需如实汇报检查结果并配合讨论治疗，
        #    故放行医学术语，仅保留隐藏疾病/系统提示词泄露拦截。
