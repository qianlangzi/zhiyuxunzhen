...
function Start-All {
    ...
    Run-Container "zhiyu-ai" @(
        ...
        "-e", "VISION_BASE_URL=https://YOUR_DASHSCOPE_WORKSPACE.cn-beijing.maas.aliyuncs.com/compatible-mode/v1", "-e", "VISION_API_KEY=$VISION_API_KEY", "-e", "VISION_MODEL=qwen3-omni-flash",
