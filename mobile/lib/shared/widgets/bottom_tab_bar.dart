...
const studentTabs = [
  ...
  TabItem(label: '问诊', icon: Icons.chat_bubble_outline, activeIcon: Icons.chat_bubble_rounded),
  TabItem(label: '错题', icon: Icons.description_outlined, activeIcon: Icons.description_rounded),
...
const teacherTabs = [
  ...
  TabItem(label: '配置', icon: Icons.settings_outlined, activeIcon: Icons.settings_rounded),
  TabItem(label: '广场', icon: Icons.storefront_outlined, activeIcon: Icons.storefront_rounded),
  TabItem(label: '我的', icon: Icons.person_outline, activeIcon: Icons.person_rounded),
];
