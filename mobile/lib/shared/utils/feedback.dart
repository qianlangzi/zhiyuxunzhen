...
class AppFeedback {
  ...
  static void error(BuildContext context, String message) {
    _snack(context, message, AppColors.vermilionOf(context), Icons.error_outline,
        const Duration(seconds: 3));
  }

  static void info(BuildContext context, String message) {
    _snack(context, message, AppColors.amberOf(context), Icons.info_outline,
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              confirmText,
              style: TextStyle(
                color: danger ? AppColors.vermilionOf(context) : AppColors.primaryOf(context),
                fontWeight: FontWeight.w600,
              ),
            ),
          ),
